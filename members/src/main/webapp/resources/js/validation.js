	function checkMember(){
		...
		let id = form.id.value;			//id는 name속성, id속성도 허용
		...
		if(id.length < 4 || id.length > 15){
			...
			pw1.select();
			return false;
		}else if(pw1 != pw2){	//pw1과 pw2가 문자열이 일치하지 않으면
			...
			form.submit();  //오류가 없다면 폼을 메인 컨트롤러로 전송
		}
	}
