		...
		<fieldset>
			...
			<ul>
				<li><label for="uid">아이디</label> <input type="text" id="uid"
					name="uid" autofocus placeholder="아이디는 5~12자까지 입력해주세요"></li>
				<li><label for="passwd">비밀번호</label> <input type="password"
					id="passwd" name="passwd" placeholder="영문자, 숫자, 특수문자 포함 7자이상 입력해주세요."></li>
				...
				<li><label for="name">이름</label> <input type="text" id="name"
					name="name" placeholder="이름은 숫자로 시작할수 없습니다."></li>
				<li>
